...
namespace Platzi.Controllers
{
    public class EscuelaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AñoDeCreación,País,Ciudad,Dirección,TipoEscuela,Id,Nombre")] Escuela escuela)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("AñoDeCreación,País,Ciudad,Dirección,TipoEscuela,Id,Nombre")] Escuela escuela)
        {
            if (id != escuela.Id)
            {
                return NotFound();
