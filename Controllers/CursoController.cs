...
namespace Platzi.Controllers
{
    public class CursoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nombre,EscuelaId,Jornada,Dirección,Id")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Nombre,EscuelaId,Jornada,Dirección,Id")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
